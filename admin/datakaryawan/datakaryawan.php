...
<body>
  ...
  <div class="container">
    ...
    <h1 class="header">data karyawan</h1>
    ...
    <table class="table table-bordered">
      ...
      <tbody>
        <?php foreach ($data as $dt) : ?>
          <tr>
            <th><?= $dt["id_karyawan"]; ?></th>
            <td><?= $dt["nama_karyawan"]; ?></td>
            <td><?= $dt["ttl_karyawan"]; ?></td>
            <td><?= $dt["alamat_karyawan"]; ?></td>
            <td><?= $dt["no_hp_karyawan"]; ?></td>
            <td><?= $dt["jbt_karyawan"]; ?></td>
            <td><?= $dt["jk_karyawan"]; ?></td>
            <td><?= $dt["pass_karyawan"]; ?></td>
            <td><a class="btn btn-warning admin" href="../../function/datakaryawan/ubahFunction.php?id=<?= $dt["id"]; ?>">ubah</a>
              <a class="btn btn-danger admin" href="../../function/datakaryawan/deleteFunction.php?id=<?= $dt["id"]; ?>">hapus</a>
            </td>
          </tr>
        <?php endforeach; ?>
