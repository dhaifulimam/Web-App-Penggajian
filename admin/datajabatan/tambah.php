    ...
    <div class="container content">
        ...
        <form action="" method="POST">
            <div class="form-group">
                ...
                <input type="number" name="id_jabatan" class="form-control" id="id_jabatan" autocomplete="off" required>
            </div>
            <div class="form-group">
                <label for="nama_jbt">nama jabatan</label>
                <input type="text" name="nama_jbt" class="form-control" id="nama_jbt" autocomplete="off" required>
            </div>
            <div class="form-group">
                <label for="gaji_jabatan">gaji jabatan</label>
                <input type="number" name="gaji_jabatan" class="form-control" id="gaji_jabatan" autocomplete="off" required>
            </div>
